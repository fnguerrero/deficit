...
const SHELL = [
  ...
  './animar.js?v=605',
  './fotos.js?v=605',
  './calibracion.js?v=605',
  './modos.js?v=605',
  './arreglos.js?v=605',
  './consecuencias.js?v=605',
  './recorte.js?v=605',
  './push.js?v=605',
  './tira-aviso.js?v=605',
  './pendiente.js?v=605',
  ...
  './plazo.js?v=605',
  './compartir.js?v=605',
  './sugerencias.js?v=605',
  './analisis.js?v=605',
  './chequeos.js?v=605',
  './claude.js?v=605',
  './productos.js?v=605',
  './sync-perfil.js?v=605',
  './fusion-dia.js?v=605',
  './sync.js?v=605',
  './estado-sync.js?v=605',
  './auth.js?v=605',
  './app.js?v=605',
  './ui/general.js?v=605',
  './ui/hoy.js?v=605',
  ...
  './ui/resumen.js?v=605',
  './ui/escaner.js?v=605',
  './ui/asistente.js?v=605',
  './ui/historial.js?v=605',
  './ui/progreso.js?v=605',
  './ui/logros.js?v=605',
  './ui/perfil.js?v=605',
  './ui/sincronizacion.js?v=605',
  './ui/cuenta.js?v=605',
  './ui/calibracion.js?v=605',
  './ui/actividades.js?v=605',
  './ui/recordatorios.js?v=605',
  './ui/ajustes.js?v=605',
  './arranque.js?v=605',
  './manifest.json',
  './icons/icon-192.png',
