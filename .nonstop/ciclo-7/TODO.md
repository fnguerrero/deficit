...
- [x] 22. `recalcularJuego` recorre el historial entero en cada render de Hoy · verif: cachear por firma
- [x] 23. `mejorRacha` recorre 400 días por cada una de las 4 rachas · verif: medir
- [x] 24. El SVG del personaje se re-genera aunque no haya cambiado nada · verif: cachear por firma
...
- [x] 27. El historial arma el DOM de todos los días de una · verif: limitar y paginar
- [ ] 28. Las imágenes en base64 del cache inflan el localStorage · verif: medir el tamaño guardado

## D. Datos raros y robustez

- [x] 29. Un estado guardado corrupto no puede dejar la app en blanco · verif: test con JSON roto
- [x] 30. Un `localStorage` lleno tiene que avisar, no fallar en silencio · verif: test con quota simulada
- [x] 31. Una fecha del futuro en `dias` no rompe las rachas · verif: test
- [x] 32. Un perfil sin altura no puede dividir por cero · verif: test
- [x] 33. Comidas con kcal absurdas (>20.000) se marcan como sospechosas · verif: test
- [x] 34. El estado importado de un respaldo se valida antes de pisar el actual · verif: test
- [x] 35. Dos pestañas abiertas no se pisan el estado · verif: escuchar `storage`

## E. Textos

- [x] 36. Los mensajes de error de red dicen qué hacer, no solo qué falló · verif: repasar los textos
- [x] 37. Los estados vacíos dicen el siguiente paso concreto · verif: repasar cada pantalla vacía
...
- [x] 40. Ningún texto trata al usuario de "usuario" · verif: grep
- [x] 41. Los plurales de 1 están bien en todos los contadores · verif: test de las funciones de texto
- [ ] 42. El texto del veredicto no promete lo que no puede saber · verif: repasar

## F. Pantalla Hoy

- [x] 43. El anillo de calorías muestra el exceso, no se queda en 100% · verif: por DOM
- [ ] 44. Tocar el anillo abre el detalle de macros · verif: por DOM
- [x] 45. La fila de acciones marca cuál es la recomendada según la hora · verif: por DOM
- [x] 46. Las comidas del día se pueden borrar deslizando o con un menú · verif: por DOM
- [x] 47. Deshacer el borrado de una comida · verif: por DOM
...
- [x] 50. El chip del modo muestra el objetivo de kcal, no solo el nombre · verif: por DOM
...
- [x] 54. El análisis se puede cancelar y el estado queda limpio · verif: por DOM
...
- [x] 58. Buscar dentro de las frecuentes · verif: por DOM
...
- [x] 62. Buscar una comida en todo el historial · verif: test
- [x] 63. El promedio semanal de kcal, visible · verif: test
- [x] 64. La tendencia del peso con media móvil de 7 días · verif: test contra valores conocidos
- [x] 65. Comparar esta semana con la anterior · verif: test
...
- [x] 68. Exportar el historial a CSV · verif: test del formato
- [x] 69. El día con más y con menos calorías del período · verif: test
- [x] 70. Cuántos días se cumplió el objetivo, en porcentaje del período · verif: test

## I. Modos y nutrición

- [x] 71. Avisar cuando el objetivo de proteína no se llega, con cuánto falta · verif: test
- [x] 72. Estimar cuándo se llega al peso objetivo al ritmo actual · verif: test
- [x] 73. Avisar si el déficit sostenido es peligroso · verif: test de los umbrales
- [x] 74. La fibra, contada y con objetivo · verif: test
- [x] 75. El agua, ajustada por el ejercicio del día · verif: test
...
- [x] 79. La racha en peligro avisa antes de que termine el día · verif: test de la hora
- [x] 80. El logro más cerca de ganarse, visible · verif: test
- [x] 81. Cuánto XP falta para el próximo nivel, en Hoy · verif: por DOM
...
- [x] 85. Un récord personal por actividad, visible · verif: por DOM

## K. Ajustes y mantenimiento

- [x] 86. Ver cuánto ocupa el estado guardado · verif: por DOM
- [x] 87. Vaciar el cache de análisis a mano · verif: por DOM
- [x] 88. Exportar e importar el estado completo · verif: test de ida y vuelta
...
- [x] 91. Borrar un día entero · verif: por DOM
- [x] 92. Cambiar el tamaño del vaso, que no siempre son 250 ml · verif: test

## L. Calidad interna

- [x] 93. `core.js` está cerca del límite: partirlo por tema · verif: tamanos.py
- [ ] 94. `tests.js` está cerca del límite · verif: tamanos.py
- [x] 95. Sacar las funciones duplicadas entre archivos · verif: grep
- [ ] 96. Un solo lugar para los formatos de número · verif: grep
- [ ] 97. Los números mágicos del CSS, a variables · verif: grep
- [x] 98. Una guarda que avise si un `id` del HTML no existe · verif: test
- [x] 99. Una guarda que detecte funciones globales duplicadas entre archivos · verif: correrla
- [x] 100. Un README que explique la arquitectura para el Nico de dentro de seis meses · verif: existe y es correcto
